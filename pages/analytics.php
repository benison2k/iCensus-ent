...
// Define available charts for the report
$available_charts = [
    'gender' => 'Gender Distribution (Pie)',
    'age' => 'Age Groups (Column)',
    'purok' => 'Population by Purok (Bar)',
    'civil_status' => 'Civil Status (Donut)',
    'blood_type' => 'Blood Types (Pie)',
    'nationality' => 'Nationality (Bar)',
];
?>
<!DOCTYPE html>
<html lang="en">
