            ...
            <form id="residentForm" method="POST" action="../core/residents_process.php">
                ...
                <div style="display:flex; flex-wrap:wrap; gap:1rem;">
                    ...
                    <div style="flex:1 1 22%; min-width:220px; display:flex; flex-direction:column; gap:0.8rem;">
                        <h4 style="border-bottom:1px solid #ddd; padding-bottom:0.3rem; color:#444;">
                    ...
                    <div style="flex:1 1 22%; min-width:220px; display:flex; flex-direction:column; gap:0.8rem;">
                        <h4 style="border-bottom:1px solid #ddd; padding-bottom:0.3rem; color:#444;">
                            <span class="material-icons">phone</span> Contact Info
                        </h4>
                    ...
                    <div style="flex:1 1 22%; min-width:220px; display:flex; flex-direction:column; gap:0.8rem;">
                        <h4 style="border-bottom:1px solid #ddd; padding-bottom:0.3rem; color:#444;">
                            <span class="material-icons">home</span> Address
                        </h4>
                    ...
                    <!-- Column 4: Residency Info -->
                    <div style="flex:1 1 22%; min-width:220px; display:flex; flex-direction:column; gap:0.8rem;">
                        <h4 style="border-bottom:1px solid #ddd; padding-bottom:0.3rem; color:#444;">
                            <span class="material-icons">assignment_ind</span> Residency Info
                        </h4>
    ...
    if(body.classList.contains('dark-mode')){
        ...
        inputs.forEach(i=>{ i.style.backgroundColor='#1e1e2f'; i.style.color='#fff'; i.style.border='1px solid #555'; });
