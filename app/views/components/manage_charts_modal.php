...
<style>
    ...
    .manage-charts-content { background-color: #fefefe; margin: 10% auto; padding: 25px; border-radius: 12px; width: 90%; max-width: 600px; } /* Made wider */
    ...
    .chart-item-actions { margin-left: auto; display: flex; gap: 0.5rem; }
